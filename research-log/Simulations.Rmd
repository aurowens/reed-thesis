...
Their linear correlation is .7626. 
...
Y appears to be correlated with X2 but that is only because they are both so highly correlated with X1. Let's see how this pattern effects a simple tree. 
...
Comparing with the `randomForest` package
