...
The function `tree` was used in previous iterations of these functions but following the guidance of the MASS textbook, I am reworking them to use `rpart`. The process for simulating the data is the same as in previous reports. 
