...
[^2]:While any curve can be approximated in a step-wise manner when the number of steps approaches $\infty$, a tree model does not converge to the linear model as the number of splits approaches $\infty$, even when the data is linear.
...
```{r , echo=FALSE, message=FALSE, warning=FALSE,fig.align='center', fig.pos = 'H',fig.height= 4, fig.cap= "\\label{fig:figorangeTree}A tree representing age \\ \\ trunk circumference in orange trees."}
plot(tO)
text(tO)
```
