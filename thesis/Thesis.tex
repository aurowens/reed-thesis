...
% Everything below added by CII
  ...
  of observations and \(N_t\) is a node in the tree. CTree's inferential
  power comes from their use of permuation tests, which will be expanded
  upon in Chapter 3. For now, lets compare the CART tree fitted on \(D_2\)
  ...
  In this situation, the bagged forest outplayed the random forest.
  \textbf{Why?}
