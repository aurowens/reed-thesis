...
% Everything below added by CII
  ...
  simulated with different correlation structures.
  ...
  \[X_4 = X_3 + E, E \sim Exponential(1)\] \#\#\#\#Table 2: Correlation of
  \(X_1,..., X_7\) and \(Y\)
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{mseRF <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{)}
  ...
  \NormalTok{for (i in }\DecValTok{1}\NormalTok{:}\DecValTok{100}\NormalTok{)\{}
    \NormalTok{rf <-}\StringTok{ }\KeywordTok{randomForest}\NormalTok{(y~., }\DataTypeTok{data =} \NormalTok{d3, }\DataTypeTok{subset =} \NormalTok{train, }\DataTypeTok{ntree =} \DecValTok{100}\NormalTok{)}
    \NormalTok{mseRF[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{((d3$y[-train] -}\StringTok{ }\KeywordTok{predict}\NormalTok{(rf, d3[-train,]))^}\DecValTok{2}\NormalTok{)}
  \NormalTok{\}}
  
  \NormalTok{mseRF <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(mseRF)}
  
  \KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{mseRF), }\DataTypeTok{data =} \NormalTok{mseRF) +}\StringTok{ }\KeywordTok{geom_histogram}\NormalTok{()}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{var}\NormalTok{(mseRF)}
  \end{Highlighting}
  \end{Shaded}
