...
% Everything below added by CII
  ...
  \includegraphics{Thesis_files/figure-latex/fig1-1.pdf}
  ...
  \includegraphics{Thesis_files/figure-latex/fig2-1.pdf}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \KeywordTok{ggplot}\NormalTok{(dp, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{W2, }\DataTypeTok{y=}\NormalTok{W3, }\DataTypeTok{color =} \NormalTok{group)) +}
  \StringTok{  }\KeywordTok{geom_point}\NormalTok{()+}
  \StringTok{  }\KeywordTok{scale_color_manual}\NormalTok{(}\DataTypeTok{values =} \NormalTok{thesis)}
  \end{Highlighting}
  \end{Shaded}
  ...
  \begin{Shaded}
  \begin{Highlighting}[]
  \NormalTok{viW2 <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(viW2)}
  \KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{viW2), }\DataTypeTok{data =} \NormalTok{viW2) +}\StringTok{ }
  \StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\DataTypeTok{fill =} \NormalTok{thesis[}\DecValTok{1}\NormalTok{], }\DataTypeTok{alpha =} \NormalTok{.}\DecValTok{8}\NormalTok{) +}
  \StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Distribution of RSS when W2 is Conditionally Permuted"}\NormalTok{)+}
  \StringTok{  }\KeywordTok{geom_vline}\NormalTok{(}\DataTypeTok{xintercept =} \NormalTok{inft[}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{])}
  \end{Highlighting}
  \end{Shaded}
