...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The values of $INFFOREST(X_j)$ are scaled in the following way: since the INFFOREST function computes the INFFTREES, (or the difference in post and pre permutation RSS), values in a tree-wise manner.
