...
```{r p2ch4, echo = FALSE, fig.cap="Partitions on the Predictor Space W2 from Y~W1,W1", results="asis"}
...
```{r p6ch4, echo = FALSE, fig.cap="Distribution of RSS when W2 is Conditionally Permuted", results="asis"}
